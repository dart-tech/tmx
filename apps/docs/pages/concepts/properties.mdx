...
The date property type is used to store dates and times into your Entities records.

### E-mail

The email property is used to store single email addresses into your entities records. An validation
