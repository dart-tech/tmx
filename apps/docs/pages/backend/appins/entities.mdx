...
Create entity/tables and configure them to meet your specific needs.

## Creating Entitiy

Entities are the foundation of your application. They are used to store data in your application.
You can create as many entities as you need. Each entitiy can have as many properties as you need.
You can also create relations between entities.
...
The date property type is used to store dates and times into your entity records.

### E-mail

The email property is used to store single email addresses into your entitiy records. An validation
