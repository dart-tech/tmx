...
Create data models/tables and configure them to meet your specific needs.

## Creating Data Models

Data models are the foundation of your application. They are used to store data in your application.
You can create as many data models as you need. Each data model can have as many properties as you need.
You can also create relations between data models.
